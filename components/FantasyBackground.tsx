...
const themes: Theme[] = [
  { name: "Dawn", gradientColors: ["#FF9A8B", "#FF6A88", "#FFD6A5"], noiseTint: "#1c1c1cff", noiseIntensity: 0.5 },
  { name: "Day", gradientColors: ["#f0ec0fff", "#99E0FF", "#A0E9FD"], noiseTint: "#1c1c1cff", noiseIntensity: 0.6 },
  { name: "Afternoon", gradientColors: ["#f3c33dff", "#EC3537", "#FFEF99"], noiseTint: "#1c1c1cff", noiseIntensity: 0.4 },
  { name: "Sunset", gradientColors: ["#FA709A", "#f3256aff", "#ff00bfff"], noiseTint: "#1c1c1cff", noiseIntensity: 0.8 },
  { name: "Night", gradientColors: ["#87e2c4ff", "#4CA1AF", "#032aa7ff"], noiseTint: "#aaaaaa", noiseIntensity: 0.4 },
];

// Light mode themes - softer, brighter variants
const lightThemes: Theme[] = [
  { name: "Dawn Light", gradientColors: ["#FF9A8B", "#FF6A88", "#FFD6A5"], noiseTint: "#1c1c1c33", noiseIntensity: 0.3 },
  { name: "Day Light", gradientColors: ["#f0ec0fff", "#99E0FF", "#A0E9FD"], noiseTint: "#1c1c1c33", noiseIntensity: 0.3 },
  { name: "Afternoon Light", gradientColors: ["#f3c33dff", "#EC3537", "#FFEF99"], noiseTint: "#1c1c1c33", noiseIntensity: 0.2 },
  { name: "Sunset Light", gradientColors: ["#FA709A", "#f3256aff", "#ff00bfff"], noiseTint: "#1c1c1c33", noiseIntensity: 0.4 },
  { name: "Night Light", gradientColors: ["#87e2c4ff", "#4CA1AF", "#032aa7ff"], noiseTint: "#1c1c1c33", noiseIntensity: 0.2 },
];
